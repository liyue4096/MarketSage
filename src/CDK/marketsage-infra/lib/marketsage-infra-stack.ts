...
export class MarketsageInfraStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // ========================================
    // Stores complete analysis reports as Markdown for download
    // Path: s3://marketsage-reports/{date}/{ticker}.md
    ...
    // Daily analysis at 3:30 PM PDT (22:30 UTC)
